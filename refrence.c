...

{
    ...
    {
    case 1:
        total1 += (land + buff + kid + pro + din + fren + dess) * 1.15; // Calculation for grand total with government taxes,and cash payment.
    ...
    case 2:
        total1 += (land + buff + kid + pro + din + fren + dess) * 1.18; // Calculation for grand total with government taxes,and credit card payment.
...

{
    ...
    {
    case 1:
        total1 += (land + buff + kid + pro + din + fren + dess) * 1.10; // Calculation for grand total with government taxes,and cash payment.
